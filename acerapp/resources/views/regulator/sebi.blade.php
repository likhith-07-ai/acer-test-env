...
@section('title', 'SEBI Disclosures | ACER Ratings')
@section('meta_description', 'Review ACER’s SEBI disclosures and regulatory compliance practices.')

@section('content')
<!-- Main Hero Banner -->
<x-page-hero title="SEBI"
    description="Our commitment to integrity, transparency, and compliance with SEBI guidelines." />

<!-- Sub Banner -->
<x-page-sub-banner :show="true" bgColor="#E1F0EC" title="SEBI Disclosures"
    subtitle="At ACER, we operate with the highest standards of ethics and regulatory compliance. Below you can access our official SEBI disclosures." />
...
<!-- Legal & Policy Documents (Code of Conduct, Conflict Policy, Withdrawal Policy, etc.) -->
<div id="legal-policies">
    <x-policies-list :policies="$policies" />
</div>
...
<x-disclaimer-banner label="Disclaimers" :descriptions="[
            ...
            'All ratings and related analyses are statements of opinion, and ACER is not liable for any losses, direct or indirect, arising from use of this publication or its contents. Users are advised to exercise their own judgment and due diligence before making any decision based on the ratings.test_edit_'
        ]" />
@endsection