<x-admin-layout>
    <div class="h-full -mx-8 -my-6 w-[calc(100%+4rem)]" x-data="pressReleaseWizard()">

        <!-- Selection Modal -->
        <div x-show="formatType === null"
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 max-w-2xl w-full mx-4">
                <h2 class="text-2xl font-bold text-center mb-8">Choose Press Release Format</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- PDF Format -->
                    <button type="button" @click="setFormat('pdf')"
                        class="flex flex-col items-center p-6 border-2 border-gray-200 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group">
                        <div
                            class="w-16 h-16 bg-gray-100 text-gray-500 rounded-full flex items-center justify-center mb-4 group-hover:bg-primary-500 group-hover:text-white transition-colors">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">PDF Format</h3>
                        <p class="text-sm text-gray-500 text-center">Upload a pre-formatted PDF. Only requires basic
                            header details and rating actions.</p>
                    </button>

                    <!-- Raw Format -->
                    <button type="button" @click="setFormat('raw')"
                        class="flex flex-col items-center p-6 border-2 border-gray-200 rounded-xl hover:border-gray-400 hover:bg-gray-50 transition-all group">
                        <div
                            class="w-16 h-16 bg-gray-100 text-gray-500 rounded-full flex items-center justify-center mb-4 group-hover:bg-primary-500 group-hover:text-white transition-colors">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2">Raw Format</h3>
                        <p class="text-sm text-gray-500 text-center">Use the full builder to create a detailed press
                            release from scratch.</p>
                    </button>
                </div>
                <div class="mt-8 text-center">
                    <a href="{{ route('admin.press-releases.index') }}"
                        class="text-gray-500 hover:text-gray-700 underline font-medium">Cancel and go back</a>
                </div>
            </div>
        </div>

        <div x-show="formatType !== null" style="display: none;"
            ...
            <div id="scrollable-content" class="flex-1 min-w-0 bg-white relative overflow-y-auto h-full">
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl text-gray-900 font-bold">Create Press Release</h1>
                            <p class="text-gray-500 text-sm mt-1">Follow the steps below to populate the press release
                                document.</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div x-show="formatType !== null" class="bg-gray-100 p-1 rounded-lg flex text-sm">
                            <button type="button" @click="setFormat('pdf')"
                                :class="{'bg-white shadow-sm font-bold text-primary-600': formatType === 'pdf', 'text-gray-600 hover:text-gray-900': formatType !== 'pdf'}"
                                class="px-3 py-1.5 rounded-md transition-all flex items-center gap-1"><i
                                    class="ri-file-pdf-line"></i> PDF</button>
                            <button type="button" @click="setFormat('raw')"
                                :class="{'bg-white shadow-sm font-bold text-primary-600': formatType === 'raw', 'text-gray-600 hover:text-gray-900': formatType !== 'raw'}"
                                class="px-3 py-1.5 rounded-md transition-all flex items-center gap-1"><i
                                    class="ri-file-text-line"></i> Raw</button>
                        </div>

                    </div>
                </div>
                <form id="press-release-form" class="px-8 pb-20" :class="{'max-w-4xl mx-auto': formatType === 'pdf'}"
                    action="{{ route('admin.press-releases.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="step-0" class="mb-16 scroll-mt-32">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Press Releases Date
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="company_name" placeholder="e.g. Tata Projects Limited"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Upload a PDF version of this press release. It
                                    will display a preview button on the front-end.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="formatType === 'raw'">
                        <div id="step-2" class="mb-16 scroll-mt-32">
                            <h2 class="text-2xl font-bold mb-8 text-gray-800 border-b pb-4">3. Analytical Approach</h2>
                            <div class="mb-8">
                                <textarea name="analytical_approach" rows="4"
                                    class="block w-full border-gray-300 rounded-lg tinymce-editor"></textarea>
                            </div>
                        </div>

                        <!-- STEP 4: Brief Summary -->
                        <div id="step-3" class="mb-16 scroll-mt-32">
                            <h2 class="text-2xl font-bold mb-8 text-gray-800 border-b pb-4">4. Brief Summary</h2>
                            <div>
                        ...
                        <div id="step-6" class="mb-16 scroll-mt-32">
                            ...
                            <div class="mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="md:col-span-2"><label class="block text-sm font-semibold mb-2">Liquidity
                                        ...
                                        class="w-full rounded-lg border-gray-300 tinymce-editor"></textarea></div>
                            </div>
                        </div>
                        ...
                        <div id="step-8" class="mb-16 scroll-mt-32">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="about_company_body" rows="6"
                                    class="w-full rounded-lg border-gray-300 tinymce-editor"></textarea>
                            </div>
                        ...
                        <div id="step-10" class="mb-16 scroll-mt-32">
                            ...
                            <div class="mb-6"><label class="block text-sm font-semibold mb-2">Non Cooperation Status (If
                                    ...
                                    placeholder="Not Applicable"></textarea></div>
                        ...
                        <div id="step-15" class="mb-16 scroll-mt-32">
                            ...
                            <textarea name="ann4_covenants" rows="3"
                                class="w-full rounded-lg border-gray-300 tinymce-editor"
                                placeholder="Covenant details..."></textarea>
                        </div>
                        ...
                        <div id="step-16" class="mb-16 scroll-mt-32">
                            ...
                            <textarea name="ann5_fsr_list" rows="3"
                                class="w-full rounded-lg border-gray-300 tinymce-editor"
                                placeholder="FSR list details..."></textarea>
                        </div>
                    ...
                    <div :class="{'md:left-[288px]': formatType === 'raw', 'md:left-[288px] justify-end': formatType === 'pdf'}"
                        ...
                        <div class="flex gap-4 items-center">
                            ...
                            <button type="button" @click="nextStep" x-show="formatType === 'raw'"
                                class="bg-gray-900 hover:bg-black text-white font-medium py-2 px-8 rounded-lg shadow transition-colors hidden">Next</button>
                            <button type="submit"
                                class="bg-primary-600 text-white font-bold py-2.5 px-10 rounded-lg hover:bg-primary-700 transition shadow-lg shadow-primary-500/20">Save
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('pressReleaseWizard', () => ({
                formatType: null,
                showSidebar: false,
                setFormat(type) {
