...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        try {
            DB::statement("ALTER TABLE documents MODIFY COLUMN regulator ENUM('SEBI', 'RBI', 'OTHER')");
        } catch (\Exception $e) {
    ...
    public function down(): void
    {
        ...
        try {
            DB::statement("ALTER TABLE documents MODIFY COLUMN regulator ENUM('SEBI', 'RBI')");
        } catch (\Exception $e) {
